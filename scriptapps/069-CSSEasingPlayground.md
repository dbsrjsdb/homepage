...
Create a focused, reliable browser-based css easing playground utility that fulfills the listed project objective: Design cubic Bézier curves and preview animations.
...
Users need a straightforward way to design cubic Bézier curves and preview animations. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core css easing playground workflow described above.
...
* [x] The core css easing playground workflow works as described.
...
* Implemented cubic Bézier x/y controls with curve visualization, easing presets, CSS output, copy action, and animated replay preview.
* Added overshoot-capable y controls, responsive layout, semantic labels, and live update feedback.
...
* The editor outputs cubic Bézier timing functions; browser CSS support determines exact preview behavior.
