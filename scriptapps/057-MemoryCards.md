...
Create a focused, reliable browser-based memory cards utility that fulfills the listed project objective: Animated matching game with generated symbols.
...
Users need a straightforward way to animated matching game with generated symbols. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core memory cards workflow described above.
...
* [x] The core memory cards workflow works as described.
...
* Implemented generated-symbol matching boards with animated flips, easy/medium/hard sizes, move/time tracking, mismatch delay, reset, and best-move persistence.
* Added responsive card styling, semantic button labels, and live game feedback.
...
* Browser storage availability may vary; the game remains playable if best moves cannot be persisted.
