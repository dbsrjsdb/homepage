...
Create a focused, reliable browser-based aspect ratio calculator utility that fulfills the listed project objective: Calculate dimensions and visually compare common ratios.
...
Users need a straightforward way to calculate dimensions and visually compare common ratios. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core aspect ratio calculator workflow described above.
...
* [x] The core aspect ratio calculator workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation using native number inputs and CSS `aspect-ratio` previews.
* Implemented target/custom ratios, missing-dimension calculations, ratio simplification, current-ratio reporting, swap/reset, visual comparison cards, and validation feedback.
* Added responsive styling, semantic labels, visible focus states, live status output, and documentation.
* Validated JavaScript syntax, whitespace, static loading, representative 16:9 dimensions and ratio output, comparison cards, accessibility attributes, and mobile rendering.
