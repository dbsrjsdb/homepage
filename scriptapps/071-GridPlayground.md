...
Create a focused, reliable browser-based grid playground utility that fulfills the listed project objective: Build CSS Grid layouts visually.
...
Users need a straightforward way to build CSS Grid layouts visually. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core grid playground workflow described above.
...
* [x] The core grid playground workflow works as described.
...
* Implemented live CSS Grid controls for item count, columns, rows, gap, and item alignment with rendered preview and copyable CSS output.
