...
Create a focused, reliable browser-based audio visualizer utility that fulfills the listed project objective: Microphone/audio input transformed into waveform/frequency graphics.
...
Users need a straightforward way to microphone/audio input transformed into waveform/frequency graphics. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core audio visualizer workflow described above.
...
* [x] The core audio visualizer workflow works as described.
...
* Implemented local microphone capture with Web Audio analyser data rendered as waveform or frequency-spectrum graphics.
* Added sensitivity control, permission/error handling, start/stop controls, idle/live state indicators, accessible labels, and responsive canvas layout.
...
* Microphone access requires a secure context and user permission; headless or restricted environments remain idle.
