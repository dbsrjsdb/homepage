...
Create a focused, reliable browser-based text diff viewer utility that fulfills the listed project objective: Paste two texts and highlight additions/removals.
...
Users need a straightforward way to paste two texts and highlight additions/removals. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core text diff viewer workflow described above.
...
* [x] The core text diff viewer workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation using a line-based longest-common-subsequence diff.
* Implemented before/after editors, highlighted additions/removals, line numbers, counts, whitespace-insensitive mode, swap, clear, and safe HTML escaping.
* Added responsive styling, semantic labels, visible focus states, live status output, a comparison-size guard, and documentation.
* Validated JavaScript syntax, whitespace, static loading, representative additions/removals, accessibility attributes, and mobile rendering.
