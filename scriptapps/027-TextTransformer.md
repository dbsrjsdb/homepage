...
Create a focused, reliable browser-based text transformer utility that fulfills the listed project objective: Case conversion, whitespace cleanup, sorting, deduplication, etc.
...
Users need a straightforward way to case conversion, whitespace cleanup, sorting, deduplication, etc. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core text transformer workflow described above.
...
* [x] The core text transformer workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation.
* Implemented case conversion, line trimming, whitespace collapsing, sorting, deduplication, copy, clear, character counts, and combined-operation feedback.
* Added responsive styling, semantic labels, visible focus states, live output, and documentation.
* Validated JavaScript syntax, whitespace, static loading, representative transformation feedback, accessibility attributes, and mobile rendering.
