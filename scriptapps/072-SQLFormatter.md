...
Create a focused, reliable browser-based sql formatter utility that fulfills the listed project objective: Paste SQL and format/highlight it locally.
...
Users need a straightforward way to paste SQL and format/highlight it locally. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core sql formatter workflow described above.
...
* [x] The core sql formatter workflow works as described.
...
* Implemented local SQL formatting with selectable indentation, sample/clear/format/copy controls, keyword/string/number highlighting, and empty-input feedback.
* Added responsive output styling, semantic labels, live status feedback, and no query persistence.
...
* This is a lightweight formatter rather than a full dialect-aware SQL parser.
