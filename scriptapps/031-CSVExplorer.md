...
Create a focused, reliable browser-based csv explorer utility that fulfills the listed project objective: Drop CSV, sort/filter columns and inspect basic statistics.
...
Users need a straightforward way to drop CSV, sort/filter columns and inspect basic statistics. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core csv explorer workflow described above.
...
* [x] The core csv explorer workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation with a small quoted-field CSV parser.
* Implemented file drop/selection, paste loading, sortable columns, global row filtering, numeric statistics, sample data, clear, and invalid CSV feedback.
* Added responsive styling, semantic labels, visible focus states, live status output, and documentation.
* Validated JavaScript syntax, whitespace, static loading, sample table rendering, numeric statistics, accessibility attributes, and mobile rendering.
