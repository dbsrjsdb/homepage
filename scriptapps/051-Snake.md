...
Create a focused, reliable browser-based snake utility that fulfills the listed project objective: Classic grid-based snake with increasing speed and local high scores.
...
Users need a straightforward way to classic grid-based snake with increasing speed and local high scores. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core snake workflow described above.
...
* [x] The core snake workflow works as described.
...
* Implemented a dependency-free canvas Snake game with keyboard/touch controls, increasing speed, pause/restart, collision handling, and score feedback.
* Added locally persisted top-five high scores, clear-score control, responsive layout, and accessible live game status.
...
* Browser storage availability may vary; gameplay remains available if high scores cannot be persisted.
