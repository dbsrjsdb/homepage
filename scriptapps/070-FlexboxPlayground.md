...
Create a focused, reliable browser-based flexbox playground utility that fulfills the listed project objective: Manipulate flex properties visually and copy generated CSS.
...
Users need a straightforward way to manipulate flex properties visually and copy generated CSS. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core flexbox playground workflow described above.
...
* [x] The core flexbox playground workflow works as described.
...
* Implemented live flexbox controls for item count, direction, wrapping, justification, alignment, and gap with rendered preview and copyable CSS output.
* Added reset/default behavior, responsive controls, semantic labels, and live update feedback.
...
* Clipboard permissions may vary by browser; generated CSS remains visible in the interface.
