...
Create a focused, reliable browser-based typing speed game utility that fulfills the listed project objective: WPM, accuracy and per-character mistake visualization.
...
Users need a straightforward way to wPM, accuracy and per-character mistake visualization. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core typing speed game workflow described above.
...
* [x] The core typing speed game workflow works as described.
...
* Implemented generated typing prompts with live WPM, accuracy, elapsed time, correct/error character visualization, restart, and recent-result persistence.
* Added accessible prompt/input states, responsive styling, and status feedback for active and completed tests.
...
* WPM is an estimate based on five characters per word; browser storage availability may vary.
