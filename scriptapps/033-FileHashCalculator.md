...
Create a focused, reliable browser-based file hash calculator utility that fulfills the listed project objective: Drop a file and calculate SHA-256/SHA-512 locally.
...
Users need a straightforward way to drop a file and calculate SHA-256/SHA-512 locally. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core file hash calculator workflow described above.
...
* [x] The core file hash calculator workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation using `crypto.subtle.digest`.
* Implemented file selection/drop, SHA-256 and SHA-512 selection, file metadata, lowercase hexadecimal digest output, copy, clear, and browser capability feedback.
* Added responsive styling, semantic labels, visible focus states, live status output, and documentation.
* Validated JavaScript syntax, whitespace, static loading, algorithm controls, Web Crypto workflow messaging, accessibility attributes, and mobile rendering.
