...
Create a focused, reliable browser-based conway's game of life utility that fulfills the listed project objective: Draw cells, run generations and load famous patterns.
...
Users need a straightforward way to draw cells, run generations and load famous patterns. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core conway's game of life workflow described above.
...
* [x] The core conway's game of life workflow works as described.
...
* Implemented an interactive wrapping 40×24 Game of Life grid with draw/toggle, play/pause, step, speed, randomize, clear, and glider/blinker/pulsar pattern loading.
* Added responsive canvas rendering, generation/population metrics, accessible controls, and live status feedback.
...
* Canvas support is required; the grid wraps at its edges by design.
