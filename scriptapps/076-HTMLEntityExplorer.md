...
Create a focused, reliable browser-based html entity explorer utility that fulfills the listed project objective: Search characters and copy entity/Unicode/HTML representations.
...
Users need a straightforward way to search characters and copy entity/Unicode/HTML representations. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core html entity explorer workflow described above.
...
* [x] The core html entity explorer workflow works as described.
...
* Added a curated reference of punctuation, symbols, arrows, math, and currency entities with named, decimal, and Unicode representations.
* Added local search, category filtering, copy controls, reset behavior, accessible status feedback, and responsive card layout.
* Escaped rendered reference values safely so entity source text remains visible instead of being interpreted as markup.
...
* The reference is curated rather than a complete catalog of every HTML5 named entity.
* Browser clipboard permissions may vary by context.
