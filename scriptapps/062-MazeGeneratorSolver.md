...
Create a focused, reliable browser-based maze generator + solver utility that fulfills the listed project objective: Generate mazes and watch BFS/A* solve them.
...
Users need a straightforward way to generate mazes and watch BFS/A* solve them. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core maze generator + solver workflow described above.
...
* [x] The core maze generator + solver workflow works as described.
...
* Implemented recursive-backtracking maze generation at three sizes with animated BFS and A* search, route visualization, hints/status, and reset controls.
* Added responsive maze rendering, semantic grid labels, legend, and clear-path behavior.
...
* Larger mazes produce longer animations; all generation and solving remain local to the browser.
