...
Create a focused, reliable browser-based tetris utility that fulfills the listed project objective: Tetromino game with ghost pieces and hold functionality.
...
Users need a straightforward way to tetromino game with ghost pieces and hold functionality. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core tetris workflow described above.
...
* [x] The core tetris workflow works as described.
...
* Implemented a dependency-free 10×20 tetromino game with rotation, movement, soft/hard drop, collision, line clearing, score/level tracking, pause, restart, ghost piece, and hold functionality.
* Added responsive styling, keyboard and touch controls, accessible live status, and next/hold previews.
...
* Gameplay depends on browser Canvas support; no backend or remote state is required.
