...
Create a focused, reliable browser-based fractal explorer utility that fulfills the listed project objective: Zoomable Mandelbrot/Julia set renderer.
...
Users need a straightforward way to zoomable Mandelbrot/Julia set renderer. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core fractal explorer workflow described above.
...
* [x] The core fractal explorer workflow works as described.
...
* Implemented local Mandelbrot and Julia rendering with selectable palettes, adjustable iterations, Julia constants, and click-based zoom navigation.
* Added reset, double-click zoom-out, zoom/status indicators, accessible controls, responsive layout, and PNG export.
...
* Rendering uses a fixed 640×480 working canvas and can be CPU-intensive at high iteration counts.
