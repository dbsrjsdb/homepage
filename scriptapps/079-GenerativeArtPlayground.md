...
Create a focused, reliable browser-based generative art playground utility that fulfills the listed project objective: Seeded Canvas artwork with sliders controlling complexity and symmetry.
...
Users need a straightforward way to seeded Canvas artwork with sliders controlling complexity and symmetry. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core generative art playground workflow described above.
...
* [x] The core generative art playground workflow works as described.
...
* Implemented deterministic Canvas artwork driven by a text seed, complexity range, symmetry range, and palette selection.
* Added random seed, generate/reset controls, live metadata/status feedback, accessible labels, responsive layout, and local PNG export.
...
* Artwork is generated at a fixed 800×600 canvas resolution and displayed responsively.
* PNG export depends on browser Canvas and download support.
