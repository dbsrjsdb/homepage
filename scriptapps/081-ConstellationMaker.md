...
Create a focused, reliable browser-based constellation maker utility that fulfills the listed project objective: Place stars, connect them, name your constellation and export it.
...
Users need a straightforward way to place stars, connect them, name your constellation and export it. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core constellation maker workflow described above.
...
* [x] The core constellation maker workflow works as described.
...
* Implemented a Canvas night sky with click-to-place stars and optional sequential connections.
* Added constellation naming, scatter/undo/clear actions, star-count feedback, accessible canvas controls, responsive layout, and PNG export.
...
* Stars are stored in memory for the current page session and are not persisted.
