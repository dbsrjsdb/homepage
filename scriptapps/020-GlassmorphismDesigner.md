...
Create a focused, reliable browser-based glassmorphism designer utility that fulfills the listed project objective: Visually configure blur, opacity, borders and backgrounds.
...
Users need a straightforward way to visually configure blur, opacity, borders and backgrounds. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core glassmorphism designer workflow described above.
...
* [x] The core glassmorphism designer workflow works as described.
...
* Added backdrop blur, panel opacity, corner radius, border opacity, glass color, and background controls.
* Added live frosted-glass preview, generated CSS display, copy action, reset behavior, and live status feedback.
* Added responsive layouts, visible focus states, and semantic controls.
* Added development and usage documentation.
* Verified static loading, glass controls, responsive viewport behavior, and accessibility markers in Chromium.
...
* Generate rgba colors and `backdrop-filter` declarations directly so copied CSS is ready to use.
