...
Create a focused, reliable browser-based password generator utility that fulfills the listed project objective: Length, character sets, memorable mode and entropy estimate.
...
Users need a straightforward way to length, character sets, memorable mode and entropy estimate. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core password generator workflow described above.
...
* [x] The core password generator workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation using the Web Crypto API.
* Implemented configurable length, character sets, memorable word mode, entropy estimate, strength meter, copy action, and validation feedback.
* Added responsive styling, semantic labels, visible focus states, live output, and local-only generation documentation.
* Validated JavaScript syntax, whitespace, static loading, generated output, entropy display, accessibility attributes, and mobile rendering.
