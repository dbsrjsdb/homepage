...
Create a focused, reliable browser-based focus ambient mixer utility that fulfills the listed project objective: Mix generated rain, noise, fan and oscillator sounds via Web Audio.
...
Users need a straightforward way to mix generated rain, noise, fan and oscillator sounds via Web Audio. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core focus ambient mixer workflow described above.
...
* [x] The core focus ambient mixer workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation using the Web Audio API.
* Implemented generated rain, noise, fan, and oscillator channels, independent toggles/volumes, master volume, presets, start/stop controls, and browser capability-safe user-gesture startup.
...
* Browser capabilities may constrain audio playback; unsupported Web Audio browsers receive a visible status message.
