...
Create a focused, reliable browser-based pixel physics sandbox utility that fulfills the listed project objective: Falling sand, water, fire and walls on a cellular grid.
...
Users need a straightforward way to falling sand, water, fire and walls on a cellular grid. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core pixel physics sandbox workflow described above.
...
* [x] The core pixel physics sandbox workflow works as described.
...
* Implemented a 120×80 cellular world with sand falling, water flowing, fire rising/dissipating, and static walls.
* Added material palette, brush-size control, pointer painting, pause, clear, accessible canvas input, status feedback, and responsive layout.
...
* The world uses a fixed 120×80 grid and intentionally simplified material rules.
* Material state is held in memory and is not persisted.
