...
Create a focused, reliable browser-based physics marble box utility that fulfills the listed project objective: Drop balls into a box with collisions, gravity and draggable obstacles.
...
Users need a straightforward way to drop balls into a box with collisions, gravity and draggable obstacles. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core physics marble box workflow described above.
...
* [x] The core physics marble box workflow works as described.
...
* Implemented live circle/rectangle physics with gravity, bounce, friction, wall collisions, and draggable obstacles.
* Added click-to-drop, burst spawning, add-obstacle, pause/reset controls, live body counts, accessible canvas input, status feedback, and responsive layout.
...
* The simulator uses simple circle/rectangle collision handling rather than a full rigid-body engine.
* Marbles and obstacles remain in memory and are not persisted.
