...
Create a focused, reliable browser-based priority matrix utility that fulfills the listed project objective: Drag tasks into urgent/important quadrants.
...
Users need a straightforward way to drag tasks into urgent/important quadrants. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core priority matrix workflow described above.
...
* [x] The core priority matrix workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation using native drag-and-drop and localStorage.
* Implemented four urgency/importance quadrants, task creation, drag movement, keyboard-accessible quadrant menus, counts, clear/restore actions, and persistence.
* Added safe task rendering, responsive styling, visible focus states, live status output, and documentation.
* Validated JavaScript syntax, whitespace, static loading, seeded quadrants and tasks, movement controls, persistence wiring, accessibility controls, and mobile rendering.
