...
Create a focused, reliable browser-based passphrase generator utility that fulfills the listed project objective: Generate readable multi-word passwords locally.
...
Users need a straightforward way to generate readable multi-word passwords locally. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core passphrase generator workflow described above.
...
* [x] The core passphrase generator workflow works as described.
...
* Implemented configurable word count, separators, capitalization, optional digits, entropy estimate, strength meter, copy action, and local-only generation.
* Added responsive styling, semantic labels, visible focus states, live output, and documentation.
* Validated JavaScript syntax, whitespace, static loading, generated passphrase output, entropy display, accessibility attributes, and mobile rendering.
