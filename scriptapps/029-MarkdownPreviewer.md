...
Create a focused, reliable browser-based markdown previewer utility that fulfills the listed project objective: Split editor/preview with downloadable HTML.
...
Users need a straightforward way to split editor/preview with downloadable HTML. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core markdown previewer workflow described above.
...
* [x] The core markdown previewer workflow works as described.
...
* Selected a dependency-free HTML, CSS, and JavaScript implementation with a small built-in Markdown renderer.
* Implemented split editor/preview, headings, emphasis, links, lists, quotes, code, fenced code blocks, toolbar insertion, live counts, clear, and standalone HTML download.
* Added HTML escaping, responsive styling, semantic labels, visible focus states, live status output, and documentation.
* Validated JavaScript syntax, whitespace, static loading, representative Markdown rendering, live counts, accessibility attributes, and mobile rendering.
