...
Create a focused, reliable browser-based minesweeper utility that fulfills the listed project objective: Difficulty presets plus custom board dimensions.
...
Users need a straightforward way to difficulty presets plus custom board dimensions. The project should provide a clear interface and immediate local feedback without unnecessary setup or data transfer.

## Requirements

* Implement the core minesweeper workflow described above.
...
* [x] The core minesweeper workflow works as described.
...
* Implemented beginner, intermediate, and custom board presets with first-click safety, mine counting, revealing, flagging, timer, win/loss states, and best-time persistence.
* Added responsive board sizing, accessible grid-cell labels, right-click/long-press controls, and validation for custom dimensions and mine counts.
...
* Browser storage availability may vary; gameplay remains available if best times cannot be persisted.
